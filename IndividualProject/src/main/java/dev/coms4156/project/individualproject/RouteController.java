...
public class RouteController {
  ...
  /**
   * Attempts to enroll a student from the specified course. If the course is full,
   * the student won't get enrolled (BAD_REQUEST).
   *
   * @param deptCode       A {@code String} representing the department.
   *
   * @param courseCode     A {@code int} representing the course within the department.
  ...
  /**
   * Endpoint for changing the enrolled student count for the course.
   * This method handles PATCH requests to change the time of a course identified by
   * department code and course code.If the course exists, its time is updated to the 
   * provided count.
   *
